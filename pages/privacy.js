...
export default function Privacy() {
    return (
        <div>
            ...
            <h1 className={"text-2xl mt-8"}>Collecting and Using Your Personal Data</h1>
            <h2 className={"text-lg mt-4"}>Types of Data Collected</h2>
            <h3 className={"text-md mt-2"}>Personal Data</h3>
            ...
            <h3 className={"text-md mt-2"}>Usage Data</h3>
            ...
            <h3 className={"text-md mt-2"}>Tracking Technologies and Cookies</h3>
            ...
            <ul className={"ml-8 list-disc"}>
                ...
                <li><strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or
                    ...
                    <a
                        ...
                        target="_blank">https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_
                    </a>
                </li>
            ...
            <h2 className={"text-lg mt-4"}>Use of Your Personal Data</h2>
            ...
            <h2 className={"text-lg mt-4"}>Retention of Your Personal Data</h2>
            ...
            <p>The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained
                ...
                periods.</p>
            <h2 className={"text-lg mt-4"}>Transfer of Your Personal Data</h2>
            ...
            <h2 className={"text-lg mt-4"}>Disclosure of Your Personal Data</h2>
            <h3 className={"text-md mt-2"}>Business Transactions</h3>
            <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred.
                ...
                Privacy Policy.</p>
            <h3 className={"text-md mt-2"}>Law enforcement</h3>
            <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do
                ...
                agency).</p>
            <h3 className={"text-md mt-2"}>Other legal requirements</h3>
            ...
            <h2 className={"text-lg mt-4"}>Security of Your Personal Data</h2>
            ...
            <h1 className={"text-2xl mt-8"}>Changes to this Privacy Policy</h1>
            ...
            <ul className={"list-disc ml-8 mb-8"}>
                <li>
                    <p>By email: Wizcode@gmail.com</p>
                </li>
            </ul>
        </div>
    )
