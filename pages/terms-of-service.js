...
export default function TermsOfService() {
    return (
        <div>
            ...
            <h2 className={"text-lg mt-4"}>Definitions</h2>
            ...
            <ul className={"ml-8 list-disc"}>
                ...
                <li>
                    <p><strong>Website</strong> refers to wizcode, accessible from <a
                        href="wizcode.co" rel="external nofollow noopener"
                        target="_blank">wizcode.co</a></p>
                </li>
                <li>
            ...
            <h1 className={"text-2xl mt-8"}>Links to Other Websites</h1>
            ...
            <h1 className={"text-2xl mt-8"}>Disputes Resolution</h1>
            ...
            <h1 className={"text-2xl mt-8"}>For European Union (EU) Users</h1>
            ...
            <h1 className={"text-2xl mt-8"}>United States Legal Compliance</h1>
            ...
            <h2 className={"text-lg mt-4"}>Severability</h2>
            ...
            <h2 className={"text-lg mt-4"}>Waiver</h2>
            <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation
                ...
                breach.</p>
            <h1 className={"text-2xl mt-8"}>Translation Interpretation</h1>
